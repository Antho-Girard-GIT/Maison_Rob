  ...
  return (
    <div className=" flex items-center justify-center">
      <div className="grid grid-cols-2 gap-4">
        <div className="card-body size-50 bg-amber-200 flex flex-col rounded shadow">
        ...
        <div className="card-body size-50 bg-amber-200 flex flex-col rounded shadow overflow-hidden">
